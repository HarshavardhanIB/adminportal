module.exports={
    ...
    MontlyUserdata:"SELECT users.role_id,users.id,users.email_id,users.user_name,user_details.first_name,user_details.last_name,users.created_date_and_time from users left join user_details on users.id=user_details.user_id where users.created_date_and_time<=? AND users.created_date_and_time>=?"
}