...
app.post('/user_details_full',async(req,res)=>
{
    try
    {       
        console.log(req.body);
...
app.put('/user_details_full',async(req,res)=>
{
    try
    {       
        console.log(req.body);
...
app.delete('/user_details_full',async(req,res)=>
{
    try{
        var authorizationKey = req.headers['authorization'];
        var token=authorizationKey.split(" ")[1];
...
app.get('/user_details_full',async(req,res)=>
{
    try{
        var authorizationKey = req.headers['authorization'];
        var token=authorizationKey.split(" ")[1];
